...
document.addEventListener('DOMContentLoaded', function(){
    ...
    const btnUpdataMenu = document.querySelector('button#btnUpdataMenu');
    const formModified = document.querySelector('form#formModified');
    
    btnUpdataMenu.addEventListener('click', function(){
